...
function DQB:CreateGUI()
    ...
    -- We therefore create the normal pfUI configuration row
    -- first and replace its EditBox with our own Slider.
    --
    ...
    local function CreateOpacitySlider(caption, category, config)
        ...
        ----------------------------------------------------
        -- IMPORTANT:
        -- Set the thumb texture BEFORE GetThumbTexture().
        ----------------------------------------------------
        ...
        -- If anything is unavailable, we simply keep the
    ...
    -- Merchant remains untouched for now.
    --------------------------------------------------------
